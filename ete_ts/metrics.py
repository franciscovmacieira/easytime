...
def info(): #Information
    ...
    "\nFor the full documentation see the library oficial website: https://franciscovmacieira.github.io/ete_ts/ or the library GitHub repository: https://github.com/franciscovmacieira/ete_ts.git" \
...
def all_metrics(series: np.ndarray, sf: int) -> tuple:
